...
# @Filename: step11_generate_own_report_return
# @Date: 2017-02-07
# @Author: Mark Wang
...
suffix = 'own'
report_path = os.path.join(data_path, 'report_data_20170205', 'own_ticker_sep')
...
def based_on_stop_loss_rate_generate_result(stop_loss_rate, folder_suffix):
    ...
    wealth_path = os.path.join(temp_path, 'cost_{}_stop_loss_{}_{}_wealth'.format(transaction_cost_str, stop_loss_str,
                                                                                  folder_suffix))
    save_path = os.path.join(result_path, 'cost_{}_stop_loss_{}_{}'.format(transaction_cost_str, stop_loss_str,
                                                                           folder_suffix))
