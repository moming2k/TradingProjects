...
from path_info import data_path, buy_only_report_data_path
from constants import Constant as const

report_path = os.path.join(data_path, 'report_data_20170205')
...
cd_result_df.to_pickle(os.path.join(report_path, 'sorted_cd_dividend.p'))
cd_result_df.to_csv(os.path.join(report_path, 'sorted_cd_dividend.csv'), encoding='utf8')
...
own_result_df.to_pickle(os.path.join(report_path, 'sorted_own.p'))
own_result_df.to_csv(os.path.join(report_path, 'sorted_own.csv'), encoding='utf8')

# Sort stock_issurance info
si_report_df = pd.read_excel(os.path.join(report_path, 'stock_issurance.xlsx'))
...
si_result_df.to_pickle(os.path.join(report_path, 'sorted_si.p'))
si_result_df.to_csv(os.path.join(report_path, 'sorted_si.csv'), encoding='utf8')
...
insider_result_df.to_pickle(os.path.join(report_path, 'sorted_insider.p'))
insider_result_df.to_csv(os.path.join(report_path, 'sorted_insider.csv'), encoding='utf8')
