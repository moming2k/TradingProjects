...
# @Filename: step25_generate_20170224_all_report_info
# @Date: 2017-02-26
# @Author: Mark Wang
...
if __name__ == '__main__':
    ...
    suffix = 'all_report_20170224_stock_20170214'
    report_path = os.path.join(Path.REPORT_DATA_PATH, 'report_data_20170224', 'fscioi_report')
