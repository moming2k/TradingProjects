...
for yahoo_file in os.listdir(os.path.join(root_path, yahoo_price)):
    ...
    if bloomberg_symbol not in stock_list:
        continue
    ...
    bloomberg_df = pd.read_excel(os.path.join(root_path, bloomberg_price, bloomberg_file), index_col=0, header=None,
