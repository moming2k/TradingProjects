...
if __name__ == '__main__':
    ...
    for col in ['pros', 'cons', 'advice', 'all']:
        df['{}CommunGNLPPol'.format(col)] = df['{}CommunGNLPPol'.format(col)].fillna(0)
        df['{}CommunGNLPMag'.format(col)] = df['{}CommunGNLPMag'.format(col)].fillna(0)
