...
dd_output_path = '/home/wangzg/Documents/WangYouan/research/Glassdoor/dd_reg_result'
da_output_path = '/home/wangzg/Documents/WangYouan/research/Glassdoor/da_reg_result'
...
for dep in dd_dep_vars:
    ...
    for ind in ind_vars:
        ...
        f.write('outreg2 using {}/{}{}Result.xls, drop(i.sic2 i.fyear) '.format(output_path, today, dep))
