...
%y=load ('C:xxxxxxx');   % load the data matrix y
...
mean_change=[0.2*ones(m/2,1)' zeros(m/2,1)']';       %the mean of each model     
y=randn(n,m)+ones(n,1)*(mean_change');  %generate y as the orginal data
